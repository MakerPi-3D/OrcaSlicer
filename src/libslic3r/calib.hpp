...
public:
    CalibPressureAdvancePattern(
        const Calib_Params &params, const DynamicPrintConfig &config, bool is_bbl_machine, bool is_makerpi_machine, Model &model, const Vec3d &origin);
    ...
    void generate_custom_gcodes(const DynamicPrintConfig &config, bool is_bbl_machine, bool is_makerpi_machine, Model &model, const Vec3d &origin);
...
private:
    void refresh_setup(const DynamicPrintConfig &config, bool is_bbl_machine, bool is_makerpi_machine, const Model &model, const Vec3d &origin);
    void _refresh_starting_point(const Model &model);
    void _refresh_writer(bool is_bbl_machine, bool is_makerpi_machine, const Model &model, const Vec3d &origin);
