...
void CalibUtils::calib_pa_pattern(const CalibInfo &calib_info, Model& model)
{
    ...
    CalibPressureAdvancePattern pa_pattern(calib_info.params, full_config, true, true, model, plate_origin);
    ...
    pa_pattern.generate_custom_gcodes(full_config, true, true, model, plate_origin);
